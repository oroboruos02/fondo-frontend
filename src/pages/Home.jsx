  ...
  {tiers.map((tier, tierIdx) => (
    <div
      ...
      className={classNames(
        tier.featured ? 'relative bg-gray-900 shadow-2xl5' : 'bg-white/60 sm:mx-8 lg:mx-0',
        tier.featured
          ? ''
          : tierIdx === 0
      ...
      style={{ backgroundImage: `url(${tier.imageUrl})`, backgroundSize: 'cover', backgroundPosition: 'center',}}
    >
      <h3
        id={tier.id}
        className={classNames(
      ...
      <p className="mt-4 flex items-baseline gap-x-2">
        ...
        <span className={classNames(tier.featured ? 'text-white' : 'text-white', 'text-base')}>
          
        </span>
      </p>
      <p
        className={classNames(tier.featured ? 'text-white' : 'text-white', 'mt-6 text-base leading-7')}
      >
        {tier.description}
      </p>
      <ul
